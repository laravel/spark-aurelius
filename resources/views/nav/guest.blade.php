            ...
            <svg class="h-37 w-auto" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 36 43" xmlns:xlink="http://www.w3.org/1999/xlink">
                <defs>
                    ...
                    <linearGradient id="b" x1="59.1%" x2="88.7%" y1="55.6%" y2="100%">
                        <stop stop-color="#F1C476" offset="0%"></stop>
                        <stop stop-color="#CC973B" offset="100%"></stop>
                    </linearGradient>
                    <linearGradient id="d" x1="11.3%" x2="40.9%" y1="0%" y2="44.4%">
                        <stop stop-color="#CC973B" offset="0%"></stop>
                        <stop stop-color="#F1C476" offset="100%"></stop>
                    </linearGradient>
                </defs>
                <g fill="none" fill-rule="evenodd">
                    <path fill="#F1C476" d="M16 8.4c7.3-7 12.3-4.4 10.8 5.7l-.2 2c7.8 0 8 5.7.6 12.7l-7 6.5c-7.5 7-12.4 4.5-11-5.7l.3-1.8c-7.8 0-8-5.7-.7-12.6l7-6.5z"></path>
                    <g transform="translate(.037 .147)">
                        <mask id="c" fill="#fff">
                            <use xlink:href="#a"></use>
                        </mask>
                        <use fill="#F1C476" xlink:href="#a"></use>
                        <path fill="url(#b)" d="M3.8-1.5h25.6v17.3H3.8" mask="url(#c)"></path>
                        <path fill="url(#d)" d="M6.6 27.3h25.6v17.3H6.6z" mask="url(#c)"></path>
                    </g>
                </g>
            </svg>
        </a>
